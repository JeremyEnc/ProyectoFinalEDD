...
public class VentanaRegistrar extends javax.swing.JDialog {
    ...
    /**
     * Constructor de la ventana Registrar
     *
     * @param parent parent
     * @param modal modal
     * @param codigo codigo necesario para registro de administrador
     */
    ...
    /**
     * Sirve para validar los datos del registro
     *
     * @return true o false si se validan los datos de registro
     */
    ...
    /**
     * Sirve para limpiar los campos de la ventana
     */
    public void limpiar() {
        txtCodigo.setText("");
        txtPassword.setText("");
    ...
    /**
     * Sirve para verificar el codigo de registro de administrador
     *
     * @return true o false si el codigo coincide
     */
     ...
     *
     * @return true o false si se completa el registro
     */
