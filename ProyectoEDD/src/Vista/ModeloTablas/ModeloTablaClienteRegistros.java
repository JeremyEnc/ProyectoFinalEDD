...
{
    Lista<Persona> personasLista = new Lista<>(); //lista de personas guardadas en el sistema

    /**
     * Constructor que recibe la lista de personas para inicializar la tabla
     * @param personasLista lista de personas guardadas en el sistema
     */
