...
{
    private Lista<Proveedor> listaProveedores; //lista de proveedores guardados en el sistema

    /**
     * Constructor que recibe la lista de proveedores para inicializar la tabla
     * @param listaProveedores lista de proveedores guardados en el sistema
     */
